...
from med2glb.methods.base import ConversionMethod
...
def _ensure_methods_loaded():
    ...
    try:
        import med2glb.methods.marching_cubes  # noqa: F401
    except ImportError:
        pass
    try:
        import med2glb.methods.classical  # noqa: F401
    except ImportError:
        pass
    try:
        import med2glb.methods.totalseg  # noqa: F401
    except ImportError:
        pass
    try:
